...
//		System.out.println(m2.preco);
		...
		m3.codigo=Integer.valueOf(JOptionPane.showInputDialog("Informe o código do produto: "));
		m3.preco=Double.valueOf(JOptionPane.showInputDialog("Informe o preço do produto: ")); 
